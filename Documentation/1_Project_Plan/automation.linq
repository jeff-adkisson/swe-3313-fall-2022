...
public class Team {
	...
	public override string ToString()
	{
		...
		AddHeading(sb, "Followed Submission Guidelines, Max 10%");
		var sections = new[] { "High Level Project Scope", "Schedule", "Team Organization", " Technical Description", "Data Management Plan", "Test Plan" };
		foreach (var section in sections) {
			AddHeading(sb, $"{section} Section, Max 13.3%");
		}
		return sb.ToString();
	}
}
